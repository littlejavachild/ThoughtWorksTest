...
public class GetCreditsCommand implements Command<String> {
    ...
    // ------------------------------------------------------------------------------
    public GetCreditsCommand(final String input, final IntergalacticDictionary dict) {
        this.input = input;
        this.dict = dict;
    }
    ...
    // ------------------------------------------------------------------------------
    private String getFormattedOutput(final String alienNumber, final String commodity, final double cost) {
